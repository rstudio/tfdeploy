...
`tfdeploys` provides a [GoogleML](https://cloud.google.com/ml-engine/docs/prediction-overview)
...
use a `tfdeploy` helper function as follows:
...
pixels and pass them to the REST API from `tfdeploy` as follows:
