---
title: 'Using Saved Models from R'
...
test <- dataset_mnist()$test$x 
processed_test <- array_reshape(test, dim = c(nrow(test), 784)) / 255
processed_test_list <- lapply(1:10, function(i) {processed_test[i,]})
